...
{
    /// <summary>
    /// ReturnDto for a SchemeQuestion object
    /// </summary>
    public class SchemeQuestionReturnDto
    {
        /// <summary>
        /// Id - Auto generated
        /// </summary>
        ...
        /// <summary>
        /// Flags - List any SchemeQuestionFlags (Red/Stop coding flags) associated with this question.
        /// </summary>
        public ICollection<SchemeQuestionFlagReturnDto> Flags { get; set; } = new List<SchemeQuestionFlagReturnDto>();
    }
}